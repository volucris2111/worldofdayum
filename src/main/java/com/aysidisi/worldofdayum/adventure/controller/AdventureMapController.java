...
public class AdventureMapController
{
	...
	@ResponseBody
	public ModelAndView build(@PathVariable final ObjectId buildingTypeId)
	{
	...
	public List<MapTilePojo> getAdventureMap()
	{
		return this.fieldService
				.getRelativeAdventureMapForAvatar(this.avatarService.getCurrentAvatar());
	}
	...
	@ResponseBody
	public ModelAndView getAvatarModal(@PathVariable final ObjectId avatarId)
	{
		ModelAndView modelAndView = ViewManager.generateModelAndView(ViewTemplate.bodyOnly,
